...
declare module 'fuse.js' {
  export default class Fuse<T> {
    constructor(list: ReadonlyArray<T>, options?: Fuse.IFuseOptions<T>, index?: Fuse.FuseIndex<T>);
    /**
     ...
     */
    search<R = T>(pattern: string | Fuse.Expression, options?: Fuse.FuseSearchOptions): Fuse.FuseResult<R>[];
    ...
    static parseIndex<U>(index: any, options?: Fuse.FuseIndexOptions<U>): Fuse.FuseIndex<U>;
  }
